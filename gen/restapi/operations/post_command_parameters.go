...
// NewPostCommandParams creates a new PostCommandParams object
// no default values defined in spec.
func NewPostCommandParams() PostCommandParams {

	return PostCommandParams{}
}

// PostCommandParams contains all the bound params for the post command operation
// typically these are obtained from a http.Request
//
// swagger:parameters postCommand
type PostCommandParams struct {
...
func (o *PostCommandParams) bindCommand(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
