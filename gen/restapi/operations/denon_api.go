...
func NewDenonAPI(spec *loads.Document) *DenonAPI {
	return &DenonAPI{
		...
		PostCommandHandler: PostCommandHandlerFunc(func(params PostCommandParams) middleware.Responder {
...
type DenonAPI struct {
	...
	// PostCommandHandler sets the operation handler for the post command operation
...
// Validate validates the registrations in the DenonAPI
func (o *DenonAPI) Validate() error {
	...
	if o.PostCommandHandler == nil {
		unregistered = append(unregistered, "PostCommandHandler")
	}
...
func (o *DenonAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/command/{command}"] = NewPostCommand(o.context, o.PostCommandHandler)
